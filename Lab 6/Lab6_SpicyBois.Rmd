...
## Your team’s plots and the answers to the two questions (conclusions)
## Your team’s recommendation and why implementing it is important for the DIA managers
## A series of individual findings and plots (separate subsections for each team member)
## A summary of who did what and what non-defaults were used to generate which plots.
