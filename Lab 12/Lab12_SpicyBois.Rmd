...
1) How does the life exp of different countries grown over the years? Which countries increase the most? Which contries did not change?
...
```{r}
ggplot(mydata %>% group_by(country) %>% summarise(cor = mean(perm_mean(1000, lifeExp, 2))), aes(x = cor)) + geom_histogram()
```
