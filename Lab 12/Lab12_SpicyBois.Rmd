...
Perm_mean creates 1000 iterations of the two-sample permuation test.
...
perm_mean1 <- function(perms = 1000, all_values, n_A) {
  ## Variables ##
  # perms: The number of permutations 
  # all_values (num): all data values
  # n_A (int): Size of group A
...
```{r}
mean_data <- perm_mean1(perms = 1000, mydata$lifeExp, 1)
#hist(mean_data)
```
...
```{r}
#corr_data <- perm_cor(1000, mydata$lifeExp, mydata$pop)
#hist(corr_data)
```
