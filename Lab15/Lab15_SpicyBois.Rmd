...
**Tools:** For this I used GGPLOT2, importing data, and tidying data.

**Implications:** This can help movie producers and studios figure out what genre they can make a movie to make a lot of revenue

**Lab 2 Reflection:** I feel like we did good on our goal. We started off not really working together but b lab 9 we started to get together and work on the lab as a team. I feel like this is one this we should keep doing. One thing that we did need to work on was organization through gitKraken just to avoid merge conflicts. I feel like my goals have changed as 6 months after graduation I would like to be going into graduate school. My 5-year goal has stayed the same
...
## Logan's Reflection on Lab 2
My goals have stayed the same as stated in Lab 2. I learned more about statitis and the impact it can have on almost everything. If I could give myself adivce at the beginning of the semester I would temm myself to start trying to communcatie with my parterners more often about the lab, stop the tendancy to procrastinate on the labs, and continues the overall work effort I did on the labs. 
