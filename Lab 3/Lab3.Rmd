...
### Team Contributions
We each worked on our individuak graphs, Logan made the TEAM chart, and Trent worked on the conclusion
=======
### Conclusion:
...
**Logan Richards:** I created the graph for the correlation between gender and general health. I used stat function, bin2, to calculate the total amount of males/females in each of the gnereral health catagories. I also ues the scale function to edit the ledgend in order to make the limits eaiser to read as well as change the default "count" title of the legend to "Number of People" to better understand the graph. 
>>>>>>> master
