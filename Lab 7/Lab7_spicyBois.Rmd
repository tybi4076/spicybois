...
## Why come in July and Augest the energy graphs look significently different from the other months? (Logan)
...
**How I Came Up With This Question**I wanted to see how energy consumption changed in a day 
```{r}
dataDay <- powerData %>% filter(day == 10, month == 10, year == 2010)
