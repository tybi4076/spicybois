...
ggplot(data = milk99, aes(milk_million)) +
  ...
  theme_get()+
  xlab('Millions of Gallons of Milk Produced')
```
...
**Findings:**  The 5 states that produced the most milk in 2015 were California, Wisconsin, New York, Idaho, and Texas. (Califonia was 1st, Texas was 5th)
...
**Findings:** The 5 states that produced the least amount of milk in 2017 were Alabama, Arkansas, Hawaii, Rhode Island, and lastly, Alaska. (Alabame being 5th from last, and Alaska being last)
...
**Jack:** I created the plot for the milk production in Gerogia. For the Georgia plot I used the filter function to only utilize data from the state of Georgia. Since Trent already did the birth year set for 1998 (the year I was born as well), I figured there was no need for two of the same graph. I created templates for the team plots to help everyone get a fast start. I also reported the 5 states with the least and most produced milk in the year 2017. For that I used the arrange function to easily find the states who had the least and the most produced milk.
